...
<body>
    ...
    @else
        <!-- ########## START: LEFT PANEL ########## -->
        <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Emarket</a></div>
        <div class="sl-sideleft">
            <div class="sl-sideleft-menu">
                <a href="{{URL::to('admin/home')}}" class="sl-menu-link active">
                ...
                <nav class="nav">
                    <div class="dropdown">
                        <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                            <span class="logged-name">Mehedi<span class="hidden-md-down"> Hasan</span></span>
